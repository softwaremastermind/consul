...
[![NIA Architecture](https://consul.io/img/nia-highlevel-diagram.svg)](https://consul.io/img/nia-highlevel-diagram.svg)
...
[![NIA Integration Program Steps](https://consul.io/img/nia-integration-program.png)](https://consul.io/img/nia-integration-program.png)
...
- Writing Consul-Terraform-Sync compatible Terraform modules using our [guide](/consul/docs/nia/terraform-modules) and [tutorial](/consul/tutorials/network-infrastructure-automation/consul-terraform-sync-module?utm_source=docs)
...
Consul-Terraform-Sync compatible modules follow the [standard module structure](/terraform/language/modules/develop). Modules can use syntax supported by Terraform version 0.13, or higher. Consul-Terraform-Sync is designed to integrate with any module that satisfies these [specifications](/consul/docs/nia/terraform-modules#module-specifications). The guide will give you an introduction of the code structure and the basics of authoring a plugin that Terraform can interact with.
