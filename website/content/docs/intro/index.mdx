...
You can also schedule Consul workloads with [HashiCorp Nomad](/nomad) to provide secure service-to-service communication between Nomad jobs and task groups. 
