...
[![Gateway Architecture](https://consul.io/img/consul-connect/svgs/consul_gateway_overview.svg)](https://consul.io/img/consul-connect/svgs/consul_gateway_overview.svg)
