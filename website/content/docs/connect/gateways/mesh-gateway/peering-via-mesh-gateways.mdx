...
[![Cluster peering with mesh gateways](https://consul.io/img/consul-connect/mesh-gateway/cluster-peering-connectivity-with-mesh-gateways.png)](https://consul.io/img/consul-connect/mesh-gateway/cluster-peering-connectivity-with-mesh-gateways.png)

</Tab>

<Tab heading="Without mesh gateways">

[![Cluster peering without mesh gateways](https://consul.io/img/consul-connect/mesh-gateway/cluster-peering-connectivity-without-mesh-gateways.png)](https://consul.io/img/consul-connect/mesh-gateway/cluster-peering-connectivity-without-mesh-gateways.png)
