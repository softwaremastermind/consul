...
[![stale consistency mode read request path](https://consul.io/img/consistency-modes/consistency-mode-stale.png)](https://consul.io/img/consistency-modes/consistency-mode-stale.png)

</Tab>

<Tab heading="Default reads">

[![default consistency mode read request path](https://consul.io/img/consistency-modes/consistency-mode-default.png)](https://consul.io/img/consistency-modes/consistency-mode-default.png)

</Tab>
<Tab heading="Consistent reads, all writes">

[![consistent consistency mode read, any write request path](https://consul.io/img/consistency-modes/consistency-mode-consistent.png)](https://consul.io/img/consistency-modes/consistency-mode-consistent.png)
...
[![consistency mode behavior across Consul datacenters with traditional WAN federation](https://consul.io/img/consistency-modes/consistency-mode-cross-datacenter-federation-traditional.png)](https://consul.io/img/consistency-modes/consistency-mode-cross-datacenter-federation-traditional.png)

</Tab>

<Tab heading="WAN federation via mesh gateways">

[![consistency mode behavior across Consul datacenters with WAN federation via mesh gateways](https://consul.io/img/consistency-modes/consistency-mode-cross-datacenter-federation-mesh-gateways.png)](https://consul.io/img/consistency-modes/consistency-mode-cross-datacenter-federation-mesh-gateways.png)
